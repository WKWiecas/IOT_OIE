...
def main(cfg):
    ...
    for split in ["test"]:   
        test_set = f"./modules/model/evaluation/carb-openie6/data/carb_sentences.txt"
        conj_data = f"./modules/model/evaluation/carb-openie6/data/carb_test-openie6.txt.conj"
        sentence2reduced, reduced2sentece = get_conj_map(conj_data)
        save_path = f"./modules/model/evaluation/carb-openie6/systems_output/detie{cfg.model.best_version}conj_output.txt"
